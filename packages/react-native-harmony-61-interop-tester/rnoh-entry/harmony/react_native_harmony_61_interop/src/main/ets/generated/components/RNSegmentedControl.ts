...
export namespace RNSegmentedControl {
  export const NAME = "RNSegmentedControl" as const

  export interface DirectRawProps {
    options: {buttons: {text: string}[], backgroundColor?: ColorValue, fontColor?: ColorValue, selectedBackgroundColor?: ColorValue, selectedFontColor?: ColorValue};
  ...
  export class PropsSelector extends ViewPropsSelector<Props, RawProps> {
    get options() {
      return this.rawProps.options;
    }
    
    get selectedIndexes() {
      return this.rawProps.selectedIndexes;
    }
  ...
  export interface EventPayloadByName {
    "change": {selectedSegmentIndex: number}
  }
