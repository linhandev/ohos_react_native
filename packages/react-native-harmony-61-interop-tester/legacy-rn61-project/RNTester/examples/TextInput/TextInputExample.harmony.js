...
/**
 * TODO: remove this file once Slider is implemented and check the
 * Auto-expanding example
 */
...
exports.examples = [
  ...
  {
    title: 'Fixed number of lines (android only)',
    render: function() {
      return (
        <View>
          <TextInput
  ...
  {
    title: 'Auto-expanding (skip it, this example depends on Slider)',
    render: function() {
      return (
        <View>
