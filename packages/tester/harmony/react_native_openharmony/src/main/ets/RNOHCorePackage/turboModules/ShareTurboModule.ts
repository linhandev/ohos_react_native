...
/**
 * NOTE: The systemShare is an interface of HarmonyOS and is incompatible with OpenHarmoy.
 * If it is an OpenHarmony device, please comment the code on line 11, 
 * and the code between lines 41 and 78.
 */
