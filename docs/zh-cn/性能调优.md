...
您可以通过链接到 RNOH 提供的 RNProjectOptions intreface 构建目标为您的代码启用一批编译和链接优化选项，参考下方示例用您项目中需要优化的 library 名称替换 rnoh_app

```cmake
target_link_libraries(rnoh_app PUBLIC RNProjectOptions)
```
