...
class TouchableOpacity extends React.Component<Props, State> {
  ...
  // 暴露 setOpacityTo 方法
  setOpacityTo = (toValue: number, duration: number) => {
    this._setOpacityTo(toValue, duration);
  }
...
const Touchable = React.forwardRef((props, ref) => {
  ...
  // 将 setOpacityTo 方法暴露给外部 ref
  React.useImperativeHandle(ref, () => ({
    setOpacityTo: touchableOpacityRef.current?.setOpacityTo,
  }));

  return <TouchableOpacity {...props} ref={touchableOpacityRef} />;
});
