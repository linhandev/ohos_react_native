...
export class BlobTurboModule extends WorkerTurboModule {
  ...
  private getWebSocketModule(): WebSocketTurboModule {
    return this.ctx.rnInstance.getWorkerTurboModule(WebSocketTurboModule.NAME);
  }

  private getNetworkingModule(): NetworkingTurboModule {
    return this.ctx.rnInstance.getWorkerTurboModule(NetworkingTurboModule.NAME);
  }
