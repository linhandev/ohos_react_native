...
CustomNode::CustomNode()
  ...
  maybeThrow(NativeNodeApi::getInstance()->registerNodeCustomEvent(
      m_nodeHandle, ARKUI_NODE_CUSTOM_EVENT_ON_MEASURE, 0, this));
  maybeThrow(NativeNodeApi::getInstance()->registerNodeCustomEvent(
      m_nodeHandle, ARKUI_NODE_CUSTOM_EVENT_ON_LAYOUT, 0, this));
}
...
void CustomNode::onCustomNodeEvent(ArkUI_NodeCustomEvent* event) {
