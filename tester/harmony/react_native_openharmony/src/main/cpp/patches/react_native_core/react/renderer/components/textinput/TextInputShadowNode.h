...
#include <react/renderer/components/textinput/TextInputEventEmitter.h> // RNOH patch
#include <react/renderer/components/textinput/TextInputProps.h> // RNOH patch
#include <react/renderer/components/textinput/TextInputState.h> // RNOH patch
